...
<hr><hr><hr><hr><hr><hr><hr><hr><hr><hr><hr><hr><hr><hr><hr><hr><hr>
    ...
    <section class="section-a">
        <div class="container">
          <div>
            <h1>Live Choice: Vote for Your Favorite!</h1>
            <p>
          ...
          <img src="image/homevote.jpg" alt="" width="650px" height="350px" />
        </div>
      </section>
      ...
      <section id="about" class="section-b">
        <div class="overlay">
          <div class="section-b-inner py-5">
            ...
            <h2 class="text-5 mt-1">Your Vote Shapes the Fate of Our Contestants! </h2>
            <p class="mt-1">
      ...
      <section class="section-c">
        <div class="gallery">
          <a href="" class="big"
            ><img src="image/cover01.jpg" alt=""
          /></a>
          <a href="" class="big"
            ><img src="image/cover 02.jpg" alt=""
          /></a>
          <a href="" class="big"
            ><img src="image/cover3.jpg" alt=""
          /></a>
          <a href="" class="big"
            ><img src="image/cover4.jpg" alt=""
          /></a>
          <a href="" class="big">
            <img src="image/cover05.jpg" alt=""
          /></a>
          <a href="" class="big"
            ><img src="image/cover6.jpg" alt=""
          /></a>
        </div>
      </section>
      ...
      <footer class="section-footer py-4 bg-primary">
        <div class="container">
          <div>
            <h2 class="text-2 mb-1">One Shot Voting</h2>
